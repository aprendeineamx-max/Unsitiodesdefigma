...
('1', 'JavaScript Desde Cero', 'javascript-desde-cero', 'Aprende JavaScript desde los fundamentos hasta conceptos avanzados', 'https://images.unsplash.com/photo-1579468118864-1b9ea3c0db4a?w=400', '1', 'Programación', 'beginner', '40 horas', 0, 4.8, 1250, NOW(), NOW()),
('2', 'React Avanzado', 'react-avanzado', 'Domina React, Hooks, Context API y más', 'https://images.unsplash.com/photo-1633356122544-f134324a6cee?w=400', '1', 'Programación', 'advanced', '60 horas', 0, 4.9, 850, NOW(), NOW()),
('3', 'Python para Data Science', 'python-para-data-science', 'Análisis de datos con Python, Pandas y NumPy', 'https://images.unsplash.com/photo-1526379095098-d400fd0bf935?w=400', '1', 'Data Science', 'intermediate', '50 horas', 0, 4.7, 920, NOW(), NOW());

-- PASO 5: Insertar módulos
...
('1', '1', '1', '¿Qué es JavaScript?', 'Introducción al lenguaje más popular de la web', 'https://www.youtube.com/watch?v=dQw4w9WgXcQ', '10 min', 1, NOW(), NOW()),
