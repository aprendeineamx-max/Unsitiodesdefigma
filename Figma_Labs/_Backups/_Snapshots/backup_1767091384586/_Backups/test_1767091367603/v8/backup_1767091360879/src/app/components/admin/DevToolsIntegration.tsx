...
import { Database, Code, FileJson, RefreshCw, Trash2, Terminal, CheckCircle, Wand2, Zap, PlayCircle, SearchCheck, FileCode, Settings, Eye, EyeOff, FileText, ShieldOff, FileSearch, ListOrdered, Rocket, Sparkles, Filter, Archive, Grid3x3, Github } from 'lucide-react';
...
type ToolView = 'none' | 'connection' | 'setup' | 'schema' | 'sync' | 'githubsync' | 'githubwriter' | 'reset' | 'sql' | 'verify' | 'wizard' | 'direct' | 'oneclick' | 'autorun' | 'verifier' | 'completescript' | 'rlskiller' | 'manualverifier' | 'stepbystep' | 'ultimatesql' | 'scriptrunner';
