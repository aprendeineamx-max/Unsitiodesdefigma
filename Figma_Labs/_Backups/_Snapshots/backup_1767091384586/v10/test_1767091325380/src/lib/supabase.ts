  ...
  public: {
    Tables: {
      ...
      github_sync_cache: {
        ...
        Insert: Omit<Database['public']['Tables']['github_sync_cache']['Row'], 'id' | 'synced_at' | 'written_to_disk' | 'written_at'>;
        Update: Partial<Database['public']['Tables']['github_sync_cache']['Insert']>;
      };
    };
    Views: {
      github_sync_stats: {
