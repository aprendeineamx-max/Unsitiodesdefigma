...
-- 1. Insertar usuarios demo
INSERT INTO users (id, email, password, created_at, updated_at) VALUES
('1', 'juan@platzi.com', 'hashed_password', NOW(), NOW()),
('2', 'maria@platzi.com', 'hashed_password', NOW(), NOW()),
('3', 'carlos@platzi.com', 'hashed_password', NOW(), NOW());
...
-- 3. Insertar cursos
INSERT INTO courses (id, title, description, thumbnail_url, instructor_id, category, difficulty, duration, price, rating, students_count, created_at, updated_at) VALUES
('1', 'JavaScript Desde Cero', 'Aprende JavaScript desde los fundamentos hasta conceptos avanzados', 'https://images.unsplash.com/photo-1579468118864-1b9ea3c0db4a?w=400', '1', 'Programación', 'beginner', 40, 0, 4.8, 1250, NOW(), NOW()),
('2', 'React Avanzado', 'Domina React, Hooks, Context API y más', 'https://images.unsplash.com/photo-1633356122544-f134324a6cee?w=400', '1', 'Programación', 'advanced', 60, 0, 4.9, 850, NOW(), NOW()),
('3', 'Python para Data Science', 'Análisis de datos con Python, Pandas y NumPy', 'https://images.unsplash.com/photo-1526379095098-d400fd0bf935?w=400', '1', 'Data Science', 'intermediate', 50, 0, 4.7, 920, NOW(), NOW());
...
-- ✅ LISTO - Base de datos con datos de prueba
