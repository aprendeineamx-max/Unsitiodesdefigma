-- ==========================================
-- ULTIMATE FIX: Eliminar TODAS las políticas RLS
-- ==========================================
-- Este script usa una consulta dinámica para eliminar TODAS las políticas

DO $$ 
DECLARE
    r RECORD;
BEGIN
    -- Iterar sobre TODAS las políticas RLS de TODAS las tablas
    FOR r IN (
