...
type ToolView = 'none' | 'connection' | 'setup' | 'schema' | 'sync' | 'githubsync' | 'reset' | 'sql' | 'verify' | 'wizard' | 'direct' | 'oneclick' | 'autorun' | 'verifier' | 'completescript' | 'rlskiller' | 'manualverifier' | 'stepbystep' | 'ultimatesql' | 'scriptrunner';
